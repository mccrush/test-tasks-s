...
Во втором задании не стал добавлять такие функции как поиск по валютам, сохранение выбранных валют в LocalStorage и т.д., так как в задании таких требований не было, но в реальном проекте эти функции были бы полезны.

И со Svelte опыта работы большого еще нет, понимаю, что есть моменты, которые можно улучшить в решении.
